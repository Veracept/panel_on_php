...
$sql = "INSERT INTO moderators (nickname, level, notes, prefix, vk, forum, days_level, days_ever, reprimands, warns, date_lvl_up, number_of_actions, moder_marks) VALUES ('$nickname', '$level','$notes', '$prefix', '$vk', '$forum', '$days_level', '$days_ever', '$reprimands', '$warns', '$date_lvl_up', '$number_of_actions', '$moder_marks')";
