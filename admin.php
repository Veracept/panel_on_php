...
<header>
    ...
    <div class="headerr">
        ...
        <h1 style="margin-left: 150px"><img src="https://rodina-nexus.com/data/assets/logo/ico.png" style="width: 25; height: 25px;"> Панель Модерации || Восточный Округ</h1>

        <section style="margin-right: -200px;" class="py-5 text-center container">
            <div class="row py-lg-5">
              <div class="col-lg-6 col-md-8 mx-auto">
                <h2 class="fw-light">Добро пожаловать, <?php echo $user['name'] ?> [Admin]</h2>
                ...
                <p>
                  ...
                  <a href="register.php" class="btn btn-secondary my-2">Регестрация Модератора[Admin]</a>
