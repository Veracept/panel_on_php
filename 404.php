...
<header>
    ...
    <div class="headerr">
        ...
        <h2 style="font-size:26px;"><img src="https://rodina-nexus.com/data/assets/logo/ico.png" style="width: 25; height: 25px;"> Привет, <?php echo $user['name'] ?>!<br> Либо у тебя нету доступа к этому разделу либо это неизвестная страница</h2>
        </div>
        <div>
